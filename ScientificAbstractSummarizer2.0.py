...
# --- ALGORYTM PODSUMOWUJĄCY ABSTRAKTY NAUKOWE I PRZYPISUJĄCY IM KATEGORIE NAUKOWĄ BY MATEUSZ GLENSZCZYK ---
...
# Funkcja Podsumowująca (Uwaga - Tutaj wklejamy nasz Abstrakt):
abstract_text = (
...
# --- KLASYFIKACJA ABSTRAKTU DO KATEGORII NAUKI ---

def classify_topic(text):
    """
    Klasyfikator, który na podstawie obecności wybranych słów kluczowych przypisuje tematykę abstraktu do dziedziny naukowej.
    Uwaga - Jeśli nie znajdzie żadnych kluczowych słów, zwróci 'Unknown'.
    """
    # Słownik tematów i odpowiadających im słów kluczowych
    topics_keywords = {
        "Computer Science": ["algorithm", "computer", "data", "machine learning", "ai", "deep learning", "neural"],
        "Physics": ["quantum", "physics", "mechanics", "particle", "energy"],
        "Biology": ["biology", "genetics", "crispr", "cell", "gene", "evolution", "biodiversity"],
        "Chemistry": ["chemical", "molecule", "reaction", "compound"],
    ...
    # Liczenie wystąpień słów kluczowych dla każdego tematu
    topic_scores = {}
    ...
    # Wybranie tematu o najwyższym wyniku
...
# Printuje wytypowaną tematykę
print("Classified Topic:\n", classify_topic(abstract_text),)
print("\n\n")
